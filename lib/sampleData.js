...
// ─── Draft Player Pool ────────────────────────────────────────────────────────
// 2026 season — ADPs reflect standard 12-team non-superflex leagues.
// QBs intentionally set to rounds 2-5 range (picks 20-60) — correct for standard.
// Sources: FantasyPros consensus ADP (July 2026), Sleeper ADP.
export const DRAFT_POOL = [
  // RBs — dominate rounds 1-2 in standard leagues
  { id: 'd1',  name: 'Jahmyr Gibbs',          position: 'RB',  team: 'DET', adp: 1.5,  projectedPts: 28.8, bye: 6  },
  { id: 'd2',  name: 'Bijan Robinson',         position: 'RB',  team: 'ATL', adp: 2.0,  projectedPts: 27.4, bye: 11 },
  { id: 'd3',  name: 'Christian McCaffrey',    position: 'RB',  team: 'SF',  adp: 4.5,  projectedPts: 26.2, bye: 8  },
  { id: 'd4',  name: 'Jonathan Taylor',        position: 'RB',  team: 'IND', adp: 5.0,  projectedPts: 24.8, bye: 13 },
  { id: 'd5',  name: 'Derrick Henry',          position: 'RB',  team: 'BAL', adp: 6.2,  projectedPts: 23.6, bye: 14 },
  { id: 'd6',  name: 'Breece Hall',            position: 'RB',  team: 'NYJ', adp: 7.8,  projectedPts: 22.4, bye: 12 },
  { id: 'd7',  name: "De'Von Achane",          position: 'RB',  team: 'MIA', adp: 9.2,  projectedPts: 21.2, bye: 10 },
  { id: 'd8',  name: 'Saquon Barkley',         position: 'RB',  team: 'PHI', adp: 11.0, projectedPts: 20.1, bye: 5  },
  { id: 'd9',  name: 'Josh Jacobs',            position: 'RB',  team: 'GB',  adp: 14.4, projectedPts: 17.8, bye: 10 },
  { id: 'd10', name: 'Aaron Jones',            position: 'RB',  team: 'MIN', adp: 19.0, projectedPts: 15.6, bye: 6  },
  { id: 'd11', name: 'Jaylen Warren',          position: 'RB',  team: 'PIT', adp: 22.8, projectedPts: 13.8, bye: 9  },
  { id: 'd12', name: 'Tyjae Spears',           position: 'RB',  team: 'TEN', adp: 25.2, projectedPts: 13.2, bye: 5  },
  { id: 'd13', name: 'Gus Edwards',            position: 'RB',  team: 'LAC', adp: 29.4, projectedPts: 12.0, bye: 5  },
  // WRs
  { id: 'd14', name: "Ja'Marr Chase",          position: 'WR',  team: 'CIN', adp: 3.5,  projectedPts: 26.8, bye: 6  },
  { id: 'd15', name: 'CeeDee Lamb',            position: 'WR',  team: 'DAL', adp: 6.8,  projectedPts: 24.2, bye: 7  },
  { id: 'd16', name: 'Tyreek Hill',            position: 'WR',  team: 'MIA', adp: 8.0,  projectedPts: 22.4, bye: 10 },
  { id: 'd17', name: 'Amon-Ra St. Brown',      position: 'WR',  team: 'DET', adp: 10.2, projectedPts: 21.6, bye: 6  },
  { id: 'd18', name: 'Puka Nacua',             position: 'WR',  team: 'LAR', adp: 12.0, projectedPts: 19.8, bye: 6  },
  { id: 'd19', name: 'DJ Moore',               position: 'WR',  team: 'CHI', adp: 15.4, projectedPts: 17.4, bye: 7  },
  { id: 'd20', name: 'Davante Adams',          position: 'WR',  team: 'NYJ', adp: 17.2, projectedPts: 16.8, bye: 12 },
  { id: 'd21', name: 'Josh Downs',             position: 'WR',  team: 'IND', adp: 20.6, projectedPts: 15.0, bye: 13 },
  { id: 'd22', name: 'Jaylen Waddle',          position: 'WR',  team: 'MIA', adp: 22.0, projectedPts: 14.4, bye: 10 },
  { id: 'd23', name: 'Elijah Moore',           position: 'WR',  team: 'CLE', adp: 27.2, projectedPts: 11.0, bye: 5  },
  // TEs
  { id: 'd24', name: 'Sam LaPorta',            position: 'TE',  team: 'DET', adp: 9.0,  projectedPts: 16.4, bye: 6  },
  { id: 'd25', name: 'Mark Andrews',           position: 'TE',  team: 'BAL', adp: 9.8,  projectedPts: 15.8, bye: 14 },
  { id: 'd26', name: 'Trey McBride',           position: 'TE',  team: 'ARI', adp: 11.4, projectedPts: 14.6, bye: 11 },
  { id: 'd27', name: 'Jake Ferguson',          position: 'TE',  team: 'DAL', adp: 15.0, projectedPts: 12.8, bye: 7  },
  { id: 'd28', name: 'Jonnu Smith',            position: 'TE',  team: 'MIA', adp: 19.2, projectedPts: 10.4, bye: 10 },
  { id: 'd29', name: 'Cole Kmet',              position: 'TE',  team: 'CHI', adp: 21.0, projectedPts: 9.8,  bye: 7  },
  // QBs — standard league ADP: rounds 2-5 (picks 20-60). Do NOT recommend before round 3.
  { id: 'd30', name: 'Josh Allen',             position: 'QB',  team: 'BUF', adp: 21.0, projectedPts: 31.2, bye: 12 },
  { id: 'd31', name: 'Lamar Jackson',          position: 'QB',  team: 'BAL', adp: 24.0, projectedPts: 30.4, bye: 14 },
  { id: 'd32', name: 'Jalen Hurts',            position: 'QB',  team: 'PHI', adp: 27.0, projectedPts: 28.8, bye: 5  },
  { id: 'd33', name: 'Patrick Mahomes',        position: 'QB',  team: 'KC',  adp: 33.0, projectedPts: 26.4, bye: 11 },
  { id: 'd34', name: 'Joe Burrow',             position: 'QB',  team: 'CIN', adp: 37.0, projectedPts: 24.0, bye: 6  },
  { id: 'd35', name: 'C.J. Stroud',            position: 'QB',  team: 'HOU', adp: 42.0, projectedPts: 22.2, bye: 14 },
  { id: 'd36', name: 'Anthony Richardson',     position: 'QB',  team: 'IND', adp: 46.0, projectedPts: 21.6, bye: 13 },
  { id: 'd37', name: 'Jordan Love',            position: 'QB',  team: 'GB',  adp: 50.0, projectedPts: 20.8, bye: 10 },
  { id: 'd38', name: 'Dak Prescott',           position: 'QB',  team: 'DAL', adp: 55.0, projectedPts: 19.2, bye: 7  },
  // Ks
  { id: 'd39', name: 'Harrison Butker',        position: 'K',   team: 'KC',  adp: 100.0, projectedPts: 10.8, bye: 11 },
  { id: 'd40', name: 'Evan McPherson',         position: 'K',   team: 'CIN', adp: 101.0, projectedPts: 10.4, bye: 6  },
  { id: 'd41', name: 'Brandon Aubrey',         position: 'K',   team: 'DAL', adp: 102.0, projectedPts: 10.2, bye: 7  },
  { id: 'd42', name: 'Jake Elliott',           position: 'K',   team: 'PHI', adp: 103.0, projectedPts: 9.8,  bye: 5  },
  { id: 'd43', name: 'Tyler Bass',             position: 'K',   team: 'BUF', adp: 104.0, projectedPts: 9.4,  bye: 12 },
  // DEFs
  { id: 'd44', name: 'San Francisco 49ers',    position: 'DEF', team: 'SF',  adp: 110.0, projectedPts: 12.4, bye: 8  },
  { id: 'd45', name: 'Dallas Cowboys',         position: 'DEF', team: 'DAL', adp: 111.0, projectedPts: 11.8, bye: 7  },
  { id: 'd46', name: 'Baltimore Ravens',       position: 'DEF', team: 'BAL', adp: 112.0, projectedPts: 11.6, bye: 14 },
  { id: 'd47', name: 'New York Jets',          position: 'DEF', team: 'NYJ', adp: 113.0, projectedPts: 11.2, bye: 12 },
  { id: 'd48', name: 'Cleveland Browns',       position: 'DEF', team: 'CLE', adp: 114.0, projectedPts: 10.6, bye: 5  },
  { id: 'd49', name: 'Pittsburgh Steelers',    position: 'DEF', team: 'PIT', adp: 115.0, projectedPts: 10.4, bye: 9  },
  { id: 'd50', name: 'Kansas City Chiefs',     position: 'DEF', team: 'KC',  adp: 116.0, projectedPts: 9.8,  bye: 11 },
];
