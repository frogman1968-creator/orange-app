 ...
 *
 * Body: { players: [...top15], roster: [...myRoster] }
...
export default async function handler(req, res) {
  ...
  const prompt = `You are an expert fantasy football analyst. A manager needs waiver wire advice for this week.
...
Give exactly 3 pickup recommendations. For each, give one sharp sentence on why they should add this player THIS week. Focus on: opportunity (injuries creating openings), matchup, recent targets/carries, bye week coverage needs.
